      ...
      <div className="space-y-5 max-w-7xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="rounded-2xl p-5 text-center text-white" style={{ background: "linear-gradient(135deg, #166534, #22c55e)" }}>
            <p className="text-3xl font-bold">{almuerzos.length}</p>
            <p className="text-white/80 text-sm mt-1 font-medium">🥗 Almuerzos</p>
          </div>
          <div className="rounded-2xl p-5 text-center text-white" style={{ background: "linear-gradient(135deg, #92400e, #f59e0b)" }}>
            <p className="text-3xl font-bold">{cenas.length}</p>
            <p className="text-white/80 text-sm mt-1 font-medium">🌙 Cenas</p>
          </div>
          <div className="rounded-2xl p-5 text-center text-white" style={{ background: "linear-gradient(135deg, #1e40af, #3b82f6)" }}>
            ...
            <p className="text-white/80 text-sm mt-1 font-medium">✅ Atendidos</p>
          </div>
          <div className="rounded-2xl p-5 text-center text-white" style={{ background: "linear-gradient(135deg, #475569, #94a3b8)" }}>
            ...
            <p className="text-white/80 text-sm mt-1 font-medium">⏳ Pendientes</p>
          </div>
        </div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {inscritos.map((insc, idx) => (
                    <tr key={insc.id} className={`border-b border-gray-50 hover:bg-gray-50 transition-colors ${idx % 2 === 0 ? "bg-white" : "bg-gray-50/50"}`}>
